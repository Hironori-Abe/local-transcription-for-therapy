...
impl InnerWebView {
  ...
  fn create_environment(
    ...
    unsafe {
      // The host application does not collect WebView2 crash dumps. Telling
      // WebView2 that crash reporting is handled by the host prevents Windows
      // from automatically sending those dumps to Microsoft.

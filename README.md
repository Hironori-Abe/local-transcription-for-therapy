...
- **校正** — ルールベース + ローカル LLM。氏名・地名など個人の特定につながりうる語の警告表示。全体校正は標準のGemma 4 E4Bに加え、分割ボタンから高精度のGemma 4 12B（NVIDIA / AMD 共通・後からダウンロード）をジョブ単位で選択可能
...
- 最新のリリースノート: [v0.9.7](docs/release-notes-v0.9.7.md)
